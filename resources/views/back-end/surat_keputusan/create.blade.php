<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight ml-32">
            {{ __('Tambah Surat Keputusan') }}
        </h2>
    </x-slot>

    <div class="p-4 sm:ml-64">
        <div class="bg-white dark:bg-gray-800 p-6 shadow-md rounded-lg">
            <h1 class="text-2xl font-bold mb-4">Form Tambah Surat Keputusan</h1>
            
            <!-- Form -->
            <form action="{{ route('surat_keputusan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="tanggal_keputusan" name="tanggal_keputusan" value="{{ old('tanggal_keputusan') }}"
                        class="mt-1 block w-full px-4 py-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300"
                        required>
                ...
                <!-- Upload File -->
                <div class="mb-4">
                    <label for="file_surat_keputusan" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Upload File (Opsional)</label>
